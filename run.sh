...
echo "python SM-R1.py -t "$2 00:00:00" -x $4 -y $5 -p $pilot_id -d $3"
python SM-R1.py -t "$2 00:00:00" -x $4 -y $5 -p $pilot_id -d $3

echo "python bulletin_script.py -t "$2 00:00:00" -x $4 -y $5 -p $pilot_id -d $3"
